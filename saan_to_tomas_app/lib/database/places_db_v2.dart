...
class PlacesDB {
  final List<Places> _places = [
    ...
    Places(
        ...
        description: "Anytime Fitness helps you in a creating a plan that truly fits your life. It means a coach and a community to support you in every possible way. And it means more options to work out anytime, anywhere.",
    ...
    Places(
        ...
        description: "Pound For Pound Fitness UST offers a variety of fitness classes, including boxing, kickboxing, and MMA. They also have a personal training program available.",
        latitude: 14.607415029687337,
        longitude: 120.99103166838223,
        category: 'Gym'),
    Places(
        name: "Ryan J Fitness Center",
        address: 'KB, Arizona Tower, Padre Campa St, Sampaloc, Manila, 1008 Metro Manila',
        description: "Ryan J Fitness Center is a well-equipped gym located near UST, offering a variety of cardio machines, free weights, group fitness classes, and personal training services.",
        latitude: 14.605179478742858,
        longitude: 120.98918072113356,
        category: 'Gym'),
    Places(
        name: "Philippine Sports Performance U-Belt Manila",
        address: 'Arsenio H, 1008 Lacson Ave, Sampaloc, Manila, 1008 Metro Manila',
        description: "Philippine Sports Performance U-Belt Manila is a haven for fitness enthusiasts, offering a comprehensive range of services to help individuals achieve their fitness goals. With a dedicated focus on helping individuals reach their full potential, Philippine Sports Performance U-Belt Manila stands as a pillar of the community, fostering a passion for health and well-being.",
    ...
    Places(
        ...
        description: "Joel's Muscles & Curves Gym is known for its affordable rates and its focus on providing a welcoming and inclusive environment for people of all fitness levels. The gym offers a variety of classes and equipment, and its trainers are always available to help members reach their fitness goals.",
    ...
    Places(
        ...
        description: "933 Creatives is a vibrant coworking space in Sampaloc, Manila, offering a pet-friendly environment, ample amenities, and a dynamic atmosphere for creative minds.",
    ...
    Places(
        ...
        description: "Nestled in the heart of Sampaloc, Manila, HomeRoom Co-Working and Study Lounge is a tranquil oasis designed to foster productivity and creativity. With ergonomic workspaces, high-speed Wi-Fi, and a plethora of amenities, HomeRoom is your haven for focused work and dedicated study sessions.",
        latitude: 14.612879691146407,
        longitude: 120.98929978015309,
        category: 'Study Hub'),
    Places(
        name: "107 Co-Working by Macao Imperial Tea",
        address: 'Pacific Suites, 1218 Santander St, Sampaloc, Manila, 1008 Metro Manila',
        description: "107 Co-Working by Macao Imperial Tea is a vibrant coworking space in Sampaloc, Manila, offering a fusion of urban and international café vibes with a conducive environment for focused work, collaborative projects, and networking opportunities. Strategically located near the University Belt, the space caters to students, professionals, entrepreneurs, and remote workers seeking a productive and inspiring workspace.",
    ...
    Places(
        ...
        description: "Stream Concept Study Hub, a haven for students, freelancers, and entrepreneurs, offers an affordable and productive coworking space in Manila. Its cafe-themed ambiance, high-speed internet, and friendly staff make it an ideal spot for focused work.",
        latitude: 14.610144279629994,
        longitude: 120.99295578266559,
        category: 'Study Hub'),
    Places(
        name: "STUDYHAVEN INC.",
        address: '2nd Floor, YOU.suites, 2113 Recto Ave, Sampaloc, Manila, 1008, Sampaloc, Manila, 1015 Metro Manila',
        description: "STUDYHAVEN INC., a haven for academic excellence and holistic development, empowers students to reach their full potential through innovative teaching, state-of-the-art facilities, and a nurturing environment.",
        latitude: 14.601416212676817,
        longitude: 120.98969222168147,
        category: 'Study Hub'),
    Places(
        name: "Manila Cafe",
        address: 'Anie\'s Place, 1015 Padre Noval St, Sampaloc, Manila, 1008 Metro Manila',
        description: "Born in Manila, named as Manila. This is your unique cafe experience. Offering strong and authentic products fused with our warm brand of service.",
    ...
    Places(
        ...
        description: "Calle Cafe by Don Gabriel UST, Dapitan is a great place to relax and study, or to catch up with friends. It is also a convenient place to stop for a quick bite to eat. It is a popular spot for students and locals alike, and is known for its affordable prices and delicious coffee.",
    ...
    Places(
        ...
        description: "7-Eleven is the largest convenience store chain in the world. There are currently around 83,485 7-Eleven stores across the world, serving customers in 17 countries including Japan, Australia, Canada, Taiwan, Mexico, Malaysia, Thailand, Singapore, Sweden and China.",
        latitude: 14.607930144599608,
        longitude: 120.99142690502482,
        category: 'Store'),
    Places(
        name: "Lawson Convenience Store",
        address: 'Unit 01 G/F Multi Deck Parking Bldg., UST Campus España Blvd. Zone 046, Brgy. 47 Sampaloc, 1015 Metro Manila',
        description: "Lawson is a Japanese convenience store chain with outlets across Asia. They offer a wide variety of products and services, including food, drinks, groceries, cosmetics, and ATM services. Lawson is known for its fresh food and its commitment to sustainability.",
    ...
    Places(
        ...
        description: "Puregold is a large supermarket chain in the Philippines. It is known for its wide variety of products, affordable prices, and convenient locations. If you are looking for a supermarket with a wide variety of products, affordable prices, and convenient locations, Puregold is a great option.",
    ...
    Places(
        ...
        description: "SM City San Lazaro is a popular shopping destination for locals and tourists alike. The mall has a wide variety of shops, including department stores, clothing stores, shoe stores, and souvenir shops. There is also a food court with a variety of restaurants to choose from.",
    ...
    Places(
        ...
        description: "Malacañang Palace, officially known as Malacañan Palace, is the official residence and principal workplace of the president of the Philippines. It is located in the Manila district of San Miguel, along Jose P. Laurel Street though it is commonly associated with Mendiola Street nearby.",
    ...
    Places(
        ...
        description: "Museum with a collection of artifacts & artwork in a former monastery adjacent to a landmark church.",
    ...
    Places(
        ...
        description: "The National Museum of the Philippines is an umbrella government organization that oversees a number of national museums in the Philippines including ethnographic, anthropological, archaeological, and visual arts collections.",
    ...
    Places(
        ...
        description: "Museo de Intramuros is an ecclesiastical museum operated and managed by the Intramuros Administration. It is located at the reconstructed San Ignacio Church and Convent within the historic walled area of Intramuros in Manila, Philippines.",
